...
- accuracy, sensitivity, specificity, precision, f1_score: reported project classification metrics
- metrics_source: describes where the displayed classification metrics come from
